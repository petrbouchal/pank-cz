...
- id: inspirace
  ...
  field-required: [title, path, categories, subtitle]
  filter-ui: true
  page-size: 1000
  template-params:
    columns: 4
    class: global-card-class
  contents: 
    - title: Mapa státu
    ...
    - title: Pracovní skupina analytiků
      ...
      categories: ["Komunita & setkávání", "Analytické útvary"]
    ...
    - title: "Starfos (TA ČR)"
      ...
      categories: ["Studie & projekty"]
    - title: "Databáze strategií"
      subtitle: Databáze strategických dokumentů ČR
      path: https://databaze-strategie.cz
      categories: ["Studie & projekty"]
    ...
    - title: Zákulisí sociologie
      subtitle: Od výzkumníků <a href = "https://stem.cz">ústavu STEM</a>
    ...
    - title: Experiencing Data
      ...
      path: https://designingforanalytics.com/experiencing-data-podcast/
      categories: ["Podcasty"]
    - title: Vybraná témata analýzy dat (v R)
      subtitle: série workshopů na sociologii FF UK v režii Aleše Vomáčky (<a href = "https://www.youtube.com/@R-workshopy">a videa na youtube</a>)
      path: https://sociology-fa-cu.github.io/vybranatemataanalyzy/
      categories: [Vzdělávání & rozvoj]
    - title: IDEA Talks
      subtitle: Video a Podcasty o studiích think tanku IDEA
      categories: ["Studie & projekty", "Podcasty"]
    ...
    - title: FORPOL [České priority]
      ...
      categories: ["Toolkity & metody"]
      path: https://www.ceskepriority.cz/forpol
    - title: AI for Academia
      subtitle: Anotovaná sbírka AI nástrojů pro výzkum
      categories: ["Toolkity & metody"]
      path: https://docs.google.com/document/d/1mb4SWtqyi1iEGCn2uTnHkPHqW3UoQr8b0xv5_81a-4Y/edit
    - title: Knihovna produktů ESF
      subtitle: "Výstupy projektů ESF – najdete mezi nimi návody a metodiky i výzkum"
      categories: ["Toolkity & metody", "Studie & projekty"]
      path: https://www.esfcr.cz/produkty-opz
    - title: UK Civil Service Analysis Function
      subtitle: Sada zdrojů pro analytiky britské státní správy
      path: https://analysisfunction.civilservice.gov.uk/
      categories: ["Toolkity & metody", "Analytické útvary", "Komunita & setkávání"]
    - title: Česko.digital
      subtitle: Komunita kolem všeho digitálního blízkému veřejnému sektoru
      path: https://cesko.digital
      categories: ["Komunita & setkávání", "Toolkity & metody", "Vzdělávání a rozvoj"]
    - title: Data vis meetup Brno
      subtitle: Brněnská setkání o vizualizaci dat
      path: https://datavismeetup.cz/
      categories: ["Komunita & setkávání", "Toolkity & metody", "Vzdělávání a rozvoj"]
    - title: R Meetup Praha
      subtitle: Pražské setkávání datařů, kteří pracují s jazykem R
      categories: ["Komunita & setkávání", "Toolkity & metody", "Vzdělávání a rozvoj"]
      path: https://www.meetup.com/prague-r-meetup-group/
    - title: Webináře edu.digital
      subtitle: "včetně záznamů"
      path: https://cesko.digital/projects/cesko-digital-edu
      categories: ["Vzdělávání a rozvoj"]
    - title: What Works Centers UK
      subtitle: Britské instituce zaměřené na přenos poznatků do veřejné správy
      path: https://www.gov.uk/guidance/what-works-network
      categories: ["Toolkity & metody"]
    - title: Toolkity & metody
      subtitle: Rozcestník metodologických příruček a toolkitů [PANK]
      path: /pruvodce/dalsi-metody
      categories: ["Toolkity & metody"]
    - title: Rozcestník repozitářů studií [PANK]
      subtitle: Kde hledat literaturu pro vaši rešerši
      path: /pruvodce/reserse-literatury#repozitare
      categories: ["Studie & projekty"]
    - title: AI nástroje na práci s literaturou [PANK]
      subtitle: Nástroje, které vám pomůžou hledat poznatky 
      path: /pruvodce/prehled-literatury#ai-nastroje
      categories: ["Toolkity & metody"]
    - title: Metodika budovania analytických kapacít [SK]
      subtitle: Standardy a postupy slovenských analytických útvarů
    ...
    - title: "Jon Baron: Evidence Newsletter"
      subtitle: Příležitostný přehled nových studií v tématech veřejných poltitik
    ...
    - title: Real World Data Science
      subtitle: Platforma britské a americké statistické společnosti
      path: https://realworlddatascience.net/
      categories: [Newslettery & blogy]
    - title: Samizdat Datažurnál
      subtitle: Newsletter datového týmu Českého rozhlasu, často zaměřený na veřejná data
      path: https://samizdat.cz/datazurnal/
      categories: [Newslettery & blogy]
    - title: Data is Plural
      subtitle: Newsletter s nečekanými zdroji dat
      path: https://www.data-is-plural.com/
      categories: [Newslettery & blogy]
    - title: Counting Stuff
      subtitle: Newsletter o práci s daty
      path: https://www.counting-stuff.com/
      categories: ["Newslettery & blogy"]
    - title: SciCommHub
      subtitle: Česká komunita zaměřená na komunikaci vědeckých poznatků
      path: https://www.scicomhub.cz/
      categories: ["Komunita & setkávání", "Newslettery & blogy"]
    - title: GovLab Digest
      subtitle: Týdenní souhrn studií a čtení k inovacím ve veřejné správě (GovLab při NYU)
      path: https://blog.thegovlab.org/
      categories: ["Newslettery & blogy", "Studie & projekty"]
    - title: Data Visualisation Society
      subtitle: Celosvětová komunita profesionálů v oblasti vizualizace dat
      path: https://www.datavisualizationsociety.org/
      categories: [Komunita & setkávání, Newslettery & blogy]
    - title: PAQ Research Blog
      subtitle: Dobré příklady komunikace analýz
      categories: [Studie & projekty, Newslettery & blogy]
      path: https://www.paqresearch.cz/research-blog
...
<div id="category-buttons" class="category-buttons">Kategorie&nbsp;&nbsp;</div>
