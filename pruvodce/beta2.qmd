...
subtitle: "Jak pracovat s externím výzkumem skrze program BETA"
editor: source
poradi: 6
format: 
  html: default
...
Jestliže zadáváte výzkumné projekty skrze program BETA2 (v budoucnu BETA3), měl by Vám tento průvodce ukázat možné způsoby zlepšení tohoto procesu, který může být časově a organizačně náročný a nemusí nést kýžené výsledky. 
...
- Vnímat svojí roli jako spojku mezi výzkumníky a zadavateli výzkumu a zajišťovat kvalitní přenos poznatků pro zadavatele.
