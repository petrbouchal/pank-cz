...
Pokud se kontakt mezi zadavatelem a analytikem ve Vašem případě týká datově analytických úloh, může se Vám hodit článek o tzv. Analytics Translators [@henkeYouDonHave2018]. 

Pokud úkol směřuje k zadání většího projektu, může se hodit využít [Manager's guide to evaluation](https://www.betterevaluation.org/frameworks-guides/managers-guide-evaluation) nebo náš návod na [-> Řízení externího výzkumu](management-externiho-vyzkumu.qmd), popř. i specificky [-> Využití programu BETA](beta2.qmd).

Pro vyladění celého procesu řízení úkolů se vám může hodit náš návod na [-> inventuru úkolů] a ještě víc seširoka publikace @nolisLeadingDataScience2022 -- opět zvláště ve vztahu k datově analytickým úlohám.

A pokud máte pocit, že vás odbavování úkolů vysiluje, možná potřebujete lépe plánovat znalostní potřeby napříč celou organizací -- k tomu zase pomůže návod [-> Identifikace znalostních potřeb](identifikace-znalostnich-potreb.qmd)
