...
- Získání “surových” dat (či jejich sběr)
- Ukládání “surových” dat
- Zpracování dat (čištění, strukturování, výběr, kompilace)
...
![](Data_lifecycle_schema.png){fig-alt="Životní cyklus dat - schéma"}
