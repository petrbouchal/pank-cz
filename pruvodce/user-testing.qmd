...
Postup pro realizaci užvatelského výzkumu jsme aplikovali na čtyřech případech:
...
- Výsledky dotazníkového šetření oddělení rovnosti mužů a žen (MPSV) slouží pro žadatelé o podporu jako podklad pro jejich rozhodování. Jedná se tak o úzkou a specifickou skupinu čtenářů, kteří mají na základě těchto výsledků učinit rozhodnutí. V tomto případě vstupoval uživatelský výzkum již do fáze designu dotazníku. 

- V rámci projektu PANK jsme také realizovali uživatelské testování prezentačního webu MPO [strategie RIS3](https://www.ris3.cz/). Vedle naplnění potřeb uživatelů byla v tomto případě důležitá i přívětivost a funkčnost webového rozhraní, se kterým interagují uživatelé.

<br>

:::{.btn .btn-resource}
[Číst případovou studii MPO→](/pripadove-studie/case-mpo.qmd)
[Číst případovou studii TA ČR→](/pripadove-studie/case-tacr.qmd)
[Číst případovou studii MPSV→](/pripadove-studie/case-mpsv.qmd)
...
## Definujte záměr uživatelského výzkumu
...
## Popište, kdo jsou potenciální čtenáři a uživatelé (uvnitř či mimo vaši organizaci)	
