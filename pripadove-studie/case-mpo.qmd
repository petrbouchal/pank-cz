...
V současné době se řada analytických výstupů prezentuje na webových kanálech. V zájmu posílení jejich využitelnosti a přehlednosti jsme navrhli postup, jak testovat webový produkt přímo s uživateli pomocí metod uživatelského designu (UX design).
...
Zkušenosti z této části spolupráce jsme promítli do návodu [Kvalitní a efektivní zprávy →](TO DO LINK)
...
- využívání a budování specializované expertizy (TC)
- spolupráce v tématu inovací napříč organizacemi (CzechInvest, TA ČR, TC - datový tým), vč. datových -  (TO DO prolink na systémovou tezi o klastrech)
