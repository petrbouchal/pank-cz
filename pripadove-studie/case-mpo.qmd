...
Teze: 
- v 1 týmu celá strategická práce (tvorba a koordinace, poskytování dat do toho prostředí, síťování aktérů v prostředí)
- přestože se nejedná o čistě analytický útvar, dělají datové produkty pro to prostředí a budujou expertizu v tématech
- datová práce hodně koncentrovaná v jednom člověku -> riziko že bez datamanagement pouze v jeho hlavě, závislost na jednom člověku
- je dobré vyhledat expertízu i mimo veřejnou správu, zejména v aplikaci technických postupů (často to už někde řeší byznys třeba...)

# Systémové bariéry TODO rozepsat nástřel a doplnit

- fragmentace policy a delivery na MPO - jedna sekce drží peníze, druhá dělá policy
- nestabilita fondových projektů - klíčová strategie státu a lidem v týmu, který ji řídí, dáváme 2-3 letou perspektivu + nezajištění kontinuity + někdy rozdílné platové podmínky mezi lidma 
