...
- rozdělit na
  - statistiky a agregovaná a neosobní data (částečně problém předávání, objevitelnosti a dostupnosti)
  - mikrodata
  - mikrodata osobní
  - totéž pro výzkum - pokud k tomu nemá přístup vědecká sféra, negeneruje užitečný výzkum
...
TODO note může být i kolektivní (viz SK) ale musí být viditelný
