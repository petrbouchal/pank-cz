...
Podpora učení se mezi jednotlivci a týmu v neformální komunitě analytiků se nabízí jako potenciálně účinný a zjevně nákladově efektivní způsob, jak rozvíjet dovednosti v oblasti práce s poznatky. Vhodným výchozím bodem může být existující Pracovní skupina pro spolupráci analytických útvarů, případně skupina absolventů pilotního vzdělávacího prohramu pro analytiky. 

Základním impulsem je poznání z naší práce s analytiky napříč státní správou, že v těchto institucích již nyní existují ostrůvky excelence v dílčích tématech, metodách a způsobech práce. Učení se od druhých v oblasti práce s poznatky pak [identifikuje i britská státní služba jako častější](https://analysisfunction.civilservice.gov.uk/careers/role-profiles-and-career-pathways/) mód než formální školení.
